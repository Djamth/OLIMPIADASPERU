...
public class ModuloController {
    ...
    @PostMapping
    @PreAuthorize("@rolSecurityService.esAdministrador(authentication) and @rolSecurityService.tieneModulo(authentication, 'modulos')")
    ...
    @GetMapping
    @PreAuthorize("@rolSecurityService.tieneModulo(authentication, 'modulos')")
